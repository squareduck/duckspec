...
/// Input to `Provider::reply_suggestions`. Conversation-local: last assistant
/// message and optional preceding user message. Freeform reply suggestion only
/// — no lifecycle heuristic or slash-command priming list.
#[derive(Debug, Clone)]
